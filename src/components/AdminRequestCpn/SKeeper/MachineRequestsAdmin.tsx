...
export default function MachineRequestsAdmin() {
  ...
  // Safe translation functions moved above fetchRequests so they can be dependencies
  const safeTranslateTaskStatus = useCallback((status: string) => {
    try {
  ...
  const safeTranslateActionType = useCallback((actionType: string) => {
    try {
  ...
  const fetchRequests = useCallback(
    ...
    [statusFilter, actionTypeFilter, safeTranslateActionType]
  );
