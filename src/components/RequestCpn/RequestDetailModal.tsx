...
import { Calendar, MapPin, AlertCircle, FileText, AlertTriangle, Bug, Wrench, Loader2, Eye } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {/* Report Badge */}
                <div className="flex flex-col space-y-2">
                  <span className="text-sm font-medium text-muted-foreground">Báo cáo</span>
                  {hasReport ? (
              ...
              <div className="space-y-3">
                {request.issues && request.issues.length > 0 ? (
                  request.issues.map((issue, index) => (
                    <div key={issue.id} className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                ...
                <div className="space-y-3">
                  {isLoadingErrors ? (
                    ...
                    errors.map((error, index) => (
                      <div key={error.errorId} className="relative p-4 bg-orange-50 border-l-4 border-orange-500 rounded-lg dark:bg-orange-950/20">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex gap-2 mt-2 ml-8">
                              {error.severity && (
                                <Badge variant="outline" className={`${getSeverityColor(error.severity)} border-0`}>
                                  {error.severity}
                                </Badge>
                              )}
                              <Badge variant="outline" className={`${getStatusColor(error.status)} border-0`}>
                ...
                <div className="space-y-3">
                  {isLoadingTechnicalIssues ? (
                    ...
                    technicalIssues.map((issue, index) => (
                      <div key={issue.technicalIssueId} className="relative p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg dark:bg-blue-950/20">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
