...
export default function TaskStatusPieChart({ data, total }: TaskStatusPieChartProps) {
  ...
  const initializeChart = useCallback(() => {
    ...
    try {
      ...
      console.error("Error initializing TaskStatusPieChart:", error);
      return null;
    }
  }, []);
    ...
    <div className="bg-background border rounded-lg shadow-sm p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-right">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Tổng công việc</p>
        </div>
      </div>
