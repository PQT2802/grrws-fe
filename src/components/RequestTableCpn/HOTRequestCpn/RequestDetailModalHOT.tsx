...
interface RequestDetailModalHOTProps {
...
export default function RequestDetailModalHOT({
    request,
    isOpen,
    onClose,
}: RequestDetailModalHOTProps) {
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    ...
                    {isLoading ? (
                        <div className="flex items-center justify-center py-8">
                            ...
                            <span className="ml-2">Đang tải chi tiết yêu cầu...</span>
                        </div>
                    ) : (
